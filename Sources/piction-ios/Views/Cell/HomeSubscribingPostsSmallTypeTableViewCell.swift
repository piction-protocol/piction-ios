//
//  HomeSubscribingPostsSmallTypeTableViewCell.swift
//  piction-ios
//
...
final class HomeSubscribingPostsSmallTypeTableViewCell: ReuseTableViewCell {
...
// MARK: - Public Method
extension HomeSubscribingPostsSmallTypeTableViewCell {
    func configure(with model: Model) {
        ...
        contentContainerView.isHidden = content?.isEmpty ?? true
